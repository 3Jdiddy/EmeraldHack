...
enum
{
    ...
    TD_TEXTSPEED,
    TD_BATTLESCENE,
    // TD_BATTLESTYLE, Some lines are commented to force a set gameplay mode.
    TD_SOUND,
    TD_BUTTONMODE,
    TD_FRAMETYPE,
};
...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].data[TD_MENUSELECTION] = /*6*/5;
...
static void Sound_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_SoundMono, 104, /*YPOS_SOUND*/32, styles[0]);
    DrawOptionMenuChoice(gText_SoundStereo, GetStringRightAlignXOffset(1, gText_SoundStereo, 198),/*YPOS_SOUND*/32, styles[1]);
}
...
static void FrameType_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_FrameType, 104, /*YPOS_FRAMETYPE*/64, 0);
    DrawOptionMenuChoice(text, 128, /*YPOS_FRAMETYPE*/64, 1);
}
...
static void ButtonMode_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_ButtonTypeNormal, 104, /*YPOS_BUTTONMODE*/48, styles[0]);
    ...
    DrawOptionMenuChoice(gText_ButtonTypeLR, xLR,/*YPOS_BUTTONMODE*/48, styles[1]);

    DrawOptionMenuChoice(gText_ButtonTypeLEqualsA, GetStringRightAlignXOffset(1, gText_ButtonTypeLEqualsA, 198),/*YPOS_BUTTONMODE*/48, styles[2]);
}
