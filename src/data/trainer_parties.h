...
//route 105 before Ensio City

static const struct TrainerMonNoItemDefaultMoves sParty_Steven3J[] = {
    {
    .iv = 0,
    .lvl = 12,
    .species = SPECIES_METAPOD,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Todd3J[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_dodinas_shroomish1[] = {
    {
    .iv = 0,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMonNoItemDefaultMoves sParty_dodinas_houndour[] = {
    {
    .iv = 0,
    .lvl = 10,
    .species = SPECIES_EEVEE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .lvl = 15,
    .species = SPECIES_SANDSHREW,
    .moves = {MOVE_BULLDOZE, MOVE_SAND_ATTACK, MOVE_POISON_STING, MOVE_SLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REFLECT, MOVE_TAILWIND, MOVE_SUBSTITUTE, MOVE_AIR_CUTTER}
    },
    {
    .iv = 100,
    .lvl = 10,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPORE, MOVE_SWORDS_DANCE, MOVE_AROMATHERAPY, MOVE_BULLET_SEED}
    },
    {
    .iv = 100,
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_WAVE, MOVE_ELECTROWEB, MOVE_INFESTATION, MOVE_SWIFT}
    },
    {
    .iv = 100,
    .lvl = 10,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUG_BUZZ, MOVE_PROTECT, MOVE_SWAGGER, MOVE_FINAL_GAMBIT}
    },
    {
    .iv = 255,
    .lvl = 13,
