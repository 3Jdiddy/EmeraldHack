const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("PRIVATE"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("PRIVATE"),
    [TRAINER_CLASS_EXPERT] = _("EXPERT"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("COLONEL"),
    [TRAINER_CLASS_BLACK_BELT] = _("BLACK BELT"),
    [TRAINER_CLASS_AQUA_LEADER] = _("GENERAL"),
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = _("COLONEL"),
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = _("GENERAL"),
    ...
    [TRAINER_CLASS_PIKE_QUEEN] = _("LEUTENANT"),
