...
const u8 gText_AButton[] = _("A hotdog"); // Unused
...
const u8 gText_DefaultNameLucy[] = _("A hotdog");
...
const u8 gText_Petalburg[] = _("100"); //tip
const u8 gText_Slateport[] = _("500"); //tip
...
const u8 gText_Dewford[] = _("Everything"); //tip
const u8 gText_Enter2[] = _("ENTER");
const u8 gText_Info2[] = _("INFO");
const u8 gText_WhatsAContest[] = _("Money");
const u8 gText_TypesOfContests[] = _("Power");
const u8 gText_Ranks[] = _("Love");
